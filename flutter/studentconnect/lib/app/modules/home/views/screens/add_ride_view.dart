...
import 'package:studentconnect/app/modules/signup/views/widget/input_textfield.dart';

import '../../controllers/home_controller.dart';

class AddRidePage extends GetView<HomeController>  {
          ...
          child: Column(
            ...
            children: [
              ...
              TextInputField(
                  ...
                  textEdCon: controller.rideNameTxtCon,
                  obscureText: false.obs),
              TextInputField(
                  labelText: 'Ride Type',
                  hintText: 'eg: Computing',
                  textEdCon: controller.rideTypeTxtCon,
                  obscureText: false.obs),
              TextInputField(
              ...
              AddButton(add: () => controller.addRide(), text: 'Add Ride')
            ],
          ),
        ),
      ),
