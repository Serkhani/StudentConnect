...
import com.app.studentconnect.repositories.RideParticipantsRepo;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
@Service
@Slf4j
@RequiredArgsConstructor
public class RideParticipantsService {
    private final RideParticipantsRepo rideParticipantsRepo;
}